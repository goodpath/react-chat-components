...
var Chat = /** @class */ (function (_super) {
    ...
    Chat.prototype.render = function () {
        return (React__default.createElement(jotai.Provider, null,
            React__default.createElement(ChatInternal, __assign$1({}, this.props))));
    };
    Chat.defaultProps = {
        channels: [],
        channelGroups: [],
    ...
    */
    useEffect(function () {
        if (React__default.isValidElement(props.emojiPicker)) {
            setPicker(React__default.cloneElement(props.emojiPicker, { onEmojiSelect: handleEmojiInsertion }));
        }
    }, [props.emojiPicker]);
    useEffect(function () {
        var timer = null;
    ...
    */
    ...
    return (React__default.createElement("div", { className: "pn-msg-input pn-msg-input--".concat(theme, " ").concat(props.disabled ? "pn-msg-input--disabled" : "") },
        React__default.createElement("div", { className: "pn-msg-input__wrapper" },
            ...
            React__default.createElement("textarea", { className: "pn-msg-input__textarea", "data-testid": "message-input", disabled: props.disabled || !!file, onChange: function (e) { return handleInputChange(e); }, onKeyPress: function (e) { return handleKeyPress(e); }, placeholder: props.placeholder, ref: inputRef, rows: props.rows, value: text }),
...
var MessageActions = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        canEdit && onEdit && React__default.createElement(Action, { icon: AiFillEdit, action: onEdit }),
        canDelete && onDelete && React__default.createElement(Action, { icon: RiDeleteBin6Line, action: onDelete })));
};
var Action = function (props) {
    var Icon = props.icon;
    var action = props.action;
    var _a = React__default.useState(false), hover = _a[0], setHover = _a[1];
    return (React__default.createElement("div", { onMouseEnter: function () { return setHover(true); }, onMouseLeave: function () { return setHover(false); }, onClick: action },
        React__default.createElement(Icon, { color: hover ? "#de2440" : "#999999", style: { padding: "0.125rem" } })));
};
...
var MessageEditor = function (_a) {
    ...
    return (React__default.createElement(Div, null,
        React__default.createElement("textarea", { style: styles$1.textarea, value: value, onChange: function (e) { return setValue(e.target.value); } }),
        React__default.createElement(Button, { onClick: function () { return onSubmit(value); } }, "Submit")));
};
var styles$1 = {
...
var ImageMessage = memo(function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        loading && (React__default.createElement("div", { style: styles.spinnerContainer },
            React__default.createElement(SvgSpinner, null))),
        React__default.createElement("img", { style: loading ? { display: "none" } : style, alt: file.name, className: "pn-msg__image", src: file.url, onLoad: onLoadHandler })));
});
var styles = {
    spinnerContainer: {
        width: 400,
...
var FileRenderer = memo(function (_a) {
    var file = _a.file, scrollToBottom = _a.scrollToBottom, scrolledBottom = _a.scrolledBottom;
    return (React__default.createElement("div", { className: "pn-msg__file" }, /\.(svg|gif|jpe?g|tiff?|png|webp|bmp)$/i.test(file.name) ? (React__default.createElement(ImageMessage, { file: file, scrolledBottom: scrolledBottom, scrollToBottom: scrollToBottom })) : (React__default.createElement("div", { className: "pn-msg__bubble" },
...
var AttachmentRenderer = function (_a) {
    ...
    return (React__default.createElement("div", { className: "pn-msg__attachments" },
        attachment.type === "image" && (React__default.createElement("img", { className: "pn-msg__image", src: (_b = attachment.image) === null || _b === void 0 ? void 0 : _b.source })),
        attachment.type === "link" && (React__default.createElement("a", { className: "pn-msg__link", href: (_c = attachment.provider) === null || _c === void 0 ? void 0 : _c.url, target: "_blank", rel: "noreferrer noopener" },
            React__default.createElement("img", { src: (_d = attachment.image) === null || _d === void 0 ? void 0 : _d.source }),
            React__default.createElement("div", null,
                React__default.createElement("p", { className: "pn-msg__link-name" },
                    React__default.createElement("img", { src: (_e = attachment.icon) === null || _e === void 0 ? void 0 : _e.source }), (_f = attachment.provider) === null || _f === void 0 ? void 0 :
                    _f.name),
...
var MessageRenderer = memo(function (_a) {
    var _b, _c, _d;
        ...
        React__default.createElement("div", { className: "pn-msg__main" },
            React__default.createElement("div", { className: "pn-msg__content" },
                React__default.createElement("div", { className: "pn-msg__title" },
                    React__default.createElement("span", { className: "pn-msg__author" },
                        (user === null || user === void 0 ? void 0 : user.name) || uuid,
                        trueSenderDisplay && React__default.createElement("span", { className: "pn-msg__true-sender" },
                            " (sent by ",
                            trueSenderDisplay,
                            ")")),
                    React__default.createElement("span", { className: "pn-msg__time" }, messageListProps.enableDate ? date : time)),
                (message === null || message === void 0 ? void 0 : message.text) &&
                    (messageListProps.bubbleRenderer &&
                        ...
                        isOwn: isOwn,
                        editedText: editedText,
                    })) : (React__default.createElement("div", { className: "pn-msg__bubble" }, editedText || (message === null || message === void 0 ? void 0 : message.text))))),
            React__default.createElement("div", { className: "pn-msg__extras" },
                file && file.name ? (React__default.createElement(FileRenderer, { file: file, scrollToBottom: scrollToBottom, scrolledBottom: scrolledBottom })) : null,
                attachments.map(function (attachment, i) { return (React__default.createElement(AttachmentRenderer, { key: i, attachment: attachment })); }),
...
var MessageList = function (props) {
    ...
    useRef(new IntersectionObserver(function (e) { return handleBottomIntersection(e[0].isIntersecting); }));
    /*
    /* Helper functions
    */
    ...
    */
    ...
    useEffect(function () {
        if (React__default.isValidElement(props.reactionsPicker)) {
            setPicker(React__default.cloneElement(props.reactionsPicker, { onEmojiSelect: handleEmojiInsertion }));
        }
    ...
    */
    var renderWelcomeMessages = function () {
        if (!props.welcomeMessages)
            return;
        return Array.isArray(props.welcomeMessages) ? (props.welcomeMessages.map(function (m) { return React__default.createElement(Item, { key: m.uuid, envelope: m }); })) : (React__default.createElement(Item, { envelope: props.welcomeMessages }));
    };
    var Item = function (_a) {
        ...
        var _b = React__default.useState(false), edit = _b[0], setEdit = _b[1];
        ...
        return (React__default.createElement("div", { className: "pn-msg ".concat(currentUserClass), key: envelope.timetoken },
            edit ? (React__default.createElement(MessageEditor, { envelope: envelope, onSubmit: onEditHandler })) : (React__default.createElement(MessageRenderer, { envelope: envelope, messageListProps: props, scrollToBottom: scrollToBottom, scrolledBottom: scrolledBottom, renderReactions: renderReactions })),
            React__default.createElement("div", { className: "pn-msg__actions" },
                ...
                props.reactionsPicker && (message === null || message === void 0 ? void 0 : message.type) !== "welcome" && (React__default.createElement("div", { className: "pn-msg__reactions-toggle", title: "Add a reaction", onClick: function (e) {
                    ...
                    React__default.createElement(SvgEmoji, null))),
                React__default.createElement(MessageActions, { canEdit: canEdit, onEdit: function () { return setEdit(!edit); }, canDelete: isOwn, onDelete: onDeleteHandler }))));
    };
        ...
        React__default.createElement("div", { className: "pn-msg-list-scroller", onScroll: props.onScroll, ref: listRef },
            ...
            messages &&
                messages.map(function (m) {
                    return React__default.createElement(Item, { key: m.timetoken, envelope: m });
                }),
            props.children,
    ...
    */
    var renderChannel = function (channel) {
        ...
        return (React__default.createElement("div", { key: channel.id, className: "pn-channel ".concat(activeClass), onClick: function () { return switchChannel(channel); } },
            ((_a = channel.custom) === null || _a === void 0 ? void 0 : _a.thumb) && (React__default.createElement("img", { className: "pn-channel__thumb", src: (_b = channel.custom) === null || _b === void 0 ? void 0 : _b.thumb, alt: "Channel thumb" })),
            React__default.createElement("div", { className: "pn-channel__title" }, props.titleRenderer ? (props.titleRenderer(channel)) : (React__default.createElement(React__default.Fragment, null,
...
export { ChannelList, Chat, ChatInternal, MemberList, MessageInput, MessageList, TypingIndicator, getLastMessageUpdate, getNameInitials, getPredefinedColor, isFilePayload, useChannelMembers, useChannels, useMessages, useOuterClick, usePresence, useSubscribe, useUser, useUserMemberships, useUsers };
